...
for i = 1:num_divisions
    ...
    m1 = mean(d1);
    M1 = mean(d1(:));
    Aij1 = bsxfun(@minus, d1, bsxfun(@mtimes, m1', ones(1,n)));
    Aij1 = bsxfun(@minus, Aij1, bsxfun(@mtimes, ones(n,1), m1));
    Aij1 = bsxfun(@plus, Aij1, M1); 
    Aij1 = Aij1 - d1/n;
    ...
    m2 = mean(d2);
    M2 = mean(d2(:));
    Aij2 = bsxfun(@minus, d2, bsxfun(@mtimes, m2', ones(1,n)));
    Aij2 = bsxfun(@minus, Aij2, bsxfun(@mtimes, ones(n,1), m2));
    Aij2 = bsxfun(@plus, Aij2, M2); 
    Aij2 = Aij2 - d2/n;
